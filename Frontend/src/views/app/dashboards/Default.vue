<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb :heading="'Cine Project'" />
  ...
  <!-- ESTO SE MODIFICO -->
              <!-- <div class="container-fluid">
                <div class="row clearfix" style="position: center">
                    ...
                    <div class="col-lg-6" >
                        <div class="card">
                            ...
                            <div class="body">
                                <canvas id="ventas" class="chartjs_graph"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6" >
                        <div class="card">
                            <div class="header" >
                                <h2>Compras (Año Actual)</h2>
                            </div>
                            <div class="body">
                                <canvas id="compras" class="chartjs_graph"></canvas>
                            </div>
                        </div>
                    </div>
